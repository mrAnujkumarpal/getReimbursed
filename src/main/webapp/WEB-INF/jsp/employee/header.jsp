...
<nav  style="background:  linear-gradient(to right, #6A1B58 0%, #6A1B58 40%, #300D2A 100%);">
    <div class="nav-wrapper">
        ...
        <ul class="side-nav" id="mobile-demo">
            ...
            <c:if test="${employeeRoleId == 5 ||employeeRoleId == 6 }">
                <li><a class='dropdown-button' href='#' data-activates='sidefeature-dropdown' data-belowOrigin="true" data-constrainWidth="false">Employee<i class="material-icons right">arrow_drop_down</i> </a></li>
                <!-- Dropdown Structure -->
                <ul id='sidefeature-dropdown' class='dropdown-content'>
                    <li><a href="/empRegistration">Add Employee</a></li>
                    <li><a href="/viewAllEmployees">All Employees</a></li>
                    <li><a href="/viewAllRoles">Employee Roles</a></li>
                </ul>
            ...
            <li><a class='dropdown-button' href='#' data-activates='sidevendor-dropdown' data-belowOrigin="true" data-constrainWidth="false">Vendor<i class="material-icons right">arrow_drop_down</i> </a></li>
            <!-- Dropdown Structure -->

            <!-- Dropdown Structure -->
            <ul id='sidevendor-dropdown' class='dropdown-content'>
                <c:if test="${employeeRoleId == 4||employeeRoleId == 5 ||employeeRoleId == 6}">
                    <li><a href="/addNewVendor">Add Vendor</a></li>
                    </c:if>
                <li><a href="/allVendors">View Vendors</a></li>
            ...
            <li>
                <a class='dropdown-button' href='#' data-activates='sidereports-dropdown' data-belowOrigin="true" data-constrainWidth="false">My Reports<i class="material-icons right">arrow_drop_down</i> </a>
            </li>
            <!-- Dropdown Structure -->
            <ul id='sidereports-dropdown' class='dropdown-content'>
                <li><a href="/expenseHistory/1">My Created Expense</a></li>
                <li><a href="/expenseHistory/2">My Submitted Expense</a></li>
                <li><a href="/expenseHistory/3">My Approved Expense</a></li>
                <li><a href="/expenseHistory/4">My Audited Expense</a></li>
            ...
            <li  Style="border-left:1px solid #e6e7e9;">
                <a class='dropdown-button' href='#' data-activates='sideprofile-dropdown' data-belowOrigin="true" data-constrainWidth="false">My Profile<i class="material-icons right">arrow_drop_down</i> </a>
            </li>
            <!-- Dropdown Structure -->
            <ul id='sideprofile-dropdown' class='dropdown-content'>
                <li><a href="/default">My Profile Page</a></li>
                <li><a href="/changePwd">Change Password</a></li>
                <li><a href="/logout">Logout</a></li>
            </ul>
